...
class TestGeminiProvider(unittest.TestCase):
    ...
    def test_init_without_key_returns_notice(self):
        with patch.dict(os.environ, {}, clear=True):
            ...
            self.assertIn("GOOGLE_API_KEY environment variable is not set", result)
    ...
    def test_generate_text_success_mocked(self):
        with patch.dict(os.environ, {"GOOGLE_API_KEY": "AIzaSyTestKey12345"}):
            with patch("google.genai.Client") as mock_client_cls:
                ...
                self.assertEqual(output, "Generated Gemini response text.")
    ...
    def test_analyze_failure_formatting(self):
        with patch.dict(os.environ, {"GOOGLE_API_KEY": "AIzaSyTestKey12345"}):
            with patch("google.genai.Client") as mock_client_cls:
                ...
                self.assertEqual(result, "Root cause: Element button[id='submit'] not found.")
    ...
    def test_generate_test_code_formatting(self):
        with patch.dict(os.environ, {"GOOGLE_API_KEY": "AIzaSyTestKey12345"}):
            with patch("google.genai.Client") as mock_client_cls:
                ...
                self.assertIn("def test_sample(page)", code)
    ...
    def test_api_error_handling(self):
        with patch.dict(os.environ, {"GOOGLE_API_KEY": "AIzaSyTestKey12345"}):
            with patch("google.genai.Client") as mock_client_cls:
                ...
                self.assertIn("Gemini Execution Error: Rate limit reached or network error", result)
