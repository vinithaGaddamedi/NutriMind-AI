...
class AIProvider(ABC):
    ...
    def generate_text(self, prompt: str, system_instruction: Optional[str] = None, response_schema: Optional[Any] = None) -> LLMResponse:
        """
        Generate text response for a given prompt with optional system instruction and structured schema.
        Returns a structured LLMResponse object containing the data and telemetry metadata.
        """
        pass
