...
from agents.infrastructure.schemas.automation_schemas import PlannerInput, GeneratorInput, ValidatorInput
...
class AutomationOrchestrator(BaseAgent):
    ...
    """
    def __init__(self):
        super().__init__(agent_name="AutomationOrchestrator")
    ...
    def execute(self, input_data: AutomationOrchestratorInput) -> AutomationOrchestratorOutput:
        ...
        planner_input = PlannerInput(
            prompt="Plan", test_scenario=input_data.test_scenario,
        ...
        generator_input = GeneratorInput(
            prompt="Generate", plan=plan_output,
        ...
        val_input = ValidatorInput(
            prompt="Validate", generated_code=gen_output.pytest_code,
