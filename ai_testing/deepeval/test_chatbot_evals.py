...
GOLDENS_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '../golden_datasets/chatbot'))
LEGACY_GOLDEN = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../../ai_testing/golden_datasets/chatbot_goldens.json'))
